...
# YAHA APNE GITHUB KE RAW LINKS DAAL DO
photo1_url = "https://githubusercontent.com"
photo2_url = "https://githubusercontent.com"
photo3_url = "https://githubusercontent.com"
photo4_url = "https://githubusercontent.com"
...
<script>
    ...
    const imageUrls = ["{photo1_url}", "{photo2_url}", "{photo3_url}", "{photo4_url}"];
    
    const images = [];
    for (let s = 0; s < 4; s++) {{
        images[s] = new Image();
        images[s].crossOrigin = "anonymous"; // Taki browser image block na kare
        images[s].src = imageUrls[s];
    }}
